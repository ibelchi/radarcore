...
class PatternClassifier:
    ...
    def classify(self, hist_data: pd.DataFrame) -> dict:
        ...
        try:
            ...
            if epsilon > 0:
                ...
                # If too many pivots: increase epsilon
                ...
                # If too few pivots: reduce epsilon
                iteration = 0
        ...
        # Percentage upside (max 252 days)
        try:
    ...
    def analyze_phase(self, hist_data: pd.DataFrame) -> dict:
        ...
        # Column robustness (avoids MultiIndex and duplicates from yfinance)
